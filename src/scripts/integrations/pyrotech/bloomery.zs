...
Bloomery.createBloomeryBuilder("bloomery/steel_nugget", <immersiveengineering:metal:8>, <minecraft:iron_ingot>)
	.setAnvilTiers(["ironclad"])
...
Bloomery.createWitherForgeBuilder("witherforge/steel_nugget", <immersiveengineering:metal:8>, <minecraft:iron_ingot>)
	.setAnvilTiers(["ironclad"])
